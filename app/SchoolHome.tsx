...
export default function Home() {
  ...
  return <main>
    ...
    <header className="site-header"><div className="shell nav-wrap">
      <a className="brand" href="#inicio" aria-label="Colegio JMS, ir al inicio"><img src={`${publicPath}/logo-jms.png`} alt="Escudo del Colegio JMS"/><span><strong>Colegio JMS</strong><small>Educando para el futuro</small></span></a>
